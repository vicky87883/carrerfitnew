...
export default function PrivacyPage() {
  return <main className="appShell"><AppNav light/><article className="legalPage">
    ...
    <p className="legalLead">This notice explains what CarrerFit processes, why it is needed, and the controls applied to private resume and account data. Last updated 19 July 2026.</p>
    ...
    <section><h2>Resume and AI processing</h2><p>Resume text is sent to the configured Groq service to create a structured career profile and evidence-based job matches. Automated extraction can be inaccurate, so important fields should be reviewed. CarrerFit does not use resume data to make hiring decisions.</p></section>
