...
export function rateLimit(request: Request, bucket: string, limit = 45) {
  ...
  const message = bucket.startsWith("auth-") ? "Too many account requests. Please wait a few minutes and try again." : bucket.startsWith("admin-") ? "Too many administrator access requests. Please wait a few minutes and try again." : bucket === "resume" ? "Too many resume analyses. Please try again in a few minutes." : "Interview practice limit reached. Please pause for a few minutes.";
